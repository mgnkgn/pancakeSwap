...
const Bridge = () => {
  ...
  return (
    <>
      <nav className="header__navbar flex-row" id={isLight ? null : "bridge-navbar-DM"}>
          ...
          <div className="header__navbar__left-logo">
            ...
            <Link to="/">
              ...
              <svg
                ...
                className="sc-8a800401-0 fGhPpn desktop-icon"
                color="text"
                width="160px"
        ...
        <div className="header__navbar__right flex-row">
          <div className="footer__section__bottom--item-1 footer__section__bottom--item" id="bridge-footer-bottom-item">
            <div className="footer__section__bottom--item-1__dark-mode-container" onClick={themeClickHandler}>
              ...
              <div id={isLight
                ? "absolute-slider-bridge-left"
                : "absolute-slider-bridge-right"}
                className={
                  isLight
      ...
      <div className="swap-container" id={isLight ? null : "bridge-main-container-DM"}>
        <div className="swap-main" id={isLight ? null : "bridge-main-DM"}>
          <div className="converter-bottom-combined">
              ...
              <div className="converter" id="converter-bridge">
                <div className="converter-br-mid">
                  <div>
                    ...
                    <div>
                      <button>
                        <svg
                          className="MuiSvgIcon-root jss384"
                          width="24px"
                          focusable="false"
                          viewBox="0 0 24 24"
                          aria-hidden="true"
                ...
                <div className="swap-page">
                  <div className="swap-page-top">
                    <div className="bridge-currency-from">
                    ...
                    <div className="swap-currency-buttoncontainer">
                      <button>
                        ...
                        >
                          <path
                            d="M3.98437 12L0.984375 12L4.98437 16L8.98437 12L5.98437 12C5.98437 8.69 8.67437 6 11.9844 6C12.9944 6 13.9544 6.25 14.7844 6.7L16.2444 5.24C15.0144 4.46 13.5544 4 11.9844 4C7.56437 4 3.98437 7.58 3.98437 12ZM17.9844 12C17.9844 15.31 15.2944 18 11.9844 18C10.9744 18 10.0144 17.75 9.18437 17.3L7.72437 18.76C8.95437 19.54 10.4144 20 11.9844 20C16.4044 20 19.9844 16.42 19.9844 12L22.9844 12L18.9844 8L14.9844 12L17.9844 12Z"
                            fill="currentColor"
                          />
                        </svg>
                        <svg
                    ...
                    <div className="converter-price-market">Total amount</div>
                    <div className="deneme123">
                      ...
                      />
                      <button
                        className="MuiButtonBase-root MuiButton-root MuiButton-outlined jss359 StgMaxButton MuiButton-outlinedPrimary MuiButton-outlinedSizeSmall MuiButton-sizeSmall"
                        tabIndex={0}
                        type="button"
                      >
                    ...
                    <div className="bridge-receive">
                      <details>
                        <summary>You will receive</summary>
                        <div>
                          <div>Slippage</div>
                          <div>0.5%</div>
                        </div>
            ...
            <div className="powered-by-stargate">
              <div>Powered By</div>
              <a
              ...
              >
                <img
                  ...
                  src="	https://bridge.pancakeswap.finance/stargate.png"
                  width={78}
                  height={20}
                  decoding="async"
                  data-nimg="future"
                  loading="lazy"
                  style={isLight ? null : { color: "transparent", filter: "invert(1)" }}
                />
              </a>
            </div>
          </div>
