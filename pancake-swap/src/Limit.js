        ...
        <div className="header__navbar__left flex-row">
          <a href="">
            <div className="header__navbar__left-logo">
              <a href="home.html"> <svg viewBox="0 0 1281 199" className="sc-8a800401-0 fGhPpn desktop-icon" color="text"
                width="160px" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <li className="header__navbar__left-links--menu">
              ...
              <ul className="header__navbar__left-links--submenu">
                ...
                <li className="flex-row">
                  ...
                  <a href=""><img src="./assets/header/New-Window.svg" alt="" /></a>
                </li>
                <li className="flex-row">
