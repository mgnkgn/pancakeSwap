    ...
    return (
        <>
            ...
            <div className={isLight ? "sub_nav" : "sub_nav-DM"}>
                <ul>
                    <li><Link to="#" className="selected_pottery">Swap</Link></li>
                    <li><Link to="/limit">Limit</Link></li>
                    <li><Link to="/liquidity">Liquidity</Link></li>
                    <li><Link to="/perpetual">Perpetual <svg viewBox="0 0 24 24" color="textSubtle" width="20px"
                    ...
                    <li><Link to="/bridge">Bridge <svg viewBox="0 0 24 24" width="20px" xmlns="http://www.w3.org/2000/svg"
