...
const Competition = () => {
    return (
      ...
      <ul>
        <li><a href="#" class="selected_farms top_links">Latest</a></li>
        <li><a href="#" class="top_links">Finished</a></li>
      </ul>
    </div>
        ...
        <div class="ranking_table_board">
          ...
          <div class="right_side">
            ...
            <div class="tabs">
              ...
              <div class="tabs_second"><p>Storm</p></div>
              <div class="tabs_second"><p>Flippers</p></div>
              <div class="tabs_second"><p>Cakers</p></div>
            </div>
            <div class="rows_grid">
      ...
      <div class="competition-prizes-content">
        ...
        <section class="competition-prizes-content-table">
          <div class="competition-prizes-content-table-heading">
            ...
            <p>Higher trading volume = higher rank!
            </p>
          </div>
          ...
          <div class="tab-content">
            <table>
              ...
              <tr>
                ...
                <td>$10.800</td>
                <td>
                  <img src="./assets/competition/MoD-champion-gold.svg" alt="Champion gold" />
                  <div>+2.500</div>
                </td>
                <td><svg></svg></td>
              </tr>
              ...
              <tr>
                ...
                <td>$25.200</td>
                <td>
                  <img src="./assets/competition/MoD-top-10-gold.svg" alt="Top10" />
                  <div>+1.250</div>
                </td>
                <td><svg></svg></td>
              </tr>
              ...
              <tr>
                ...
                <td>$21.600</td>
                <td>
                  <img src="./assets/competition/MoD-top-100-gold.svg" alt="Top100" />
                  <div>+1.000</div>
                </td>
                <td><svg></svg></td>
              </tr>
              ...
              <tr>
                ...
                <td>$14.400</td>
                <td>
                  <img src="./assets/competition/MoD-top-500-gold.svg" alt="Top500" />
                  <div>+850</div>
                </td>
                <td><svg></svg></td>
              </tr>
              ...
              <tr>
                ...
                <td>$0</td>
                <td>
                  <img src="./assets/competition/MoD-participant-gold.svg" alt="participate" />
                  <div>+500</div>
                </td>
                <td><svg></svg></td>
              </tr>
        ...
        <section class="competition-prizes-content-right">
          <p>Every eligible participant will win prizes at the end of the competition.
          </p>
          <h3>The better your team performs, the better prizes you will get!
          </h3>
          <p>The final winning team will be the team with the highest total volume score at the end of the competition period.
          </p>
          <p>In addition to token prizes there are NFT rewards:
          </p>
          <p>A. 300 newly-designed PancakeSwap NFTs to the Top 100 Traders in each team.
          </p>
          <p>B. 100 Mines of Dalarnia NFTs to the Top 100 Traders ranked by the $DAR Trading Volume.
          </p>
          <img src="./assets/competition/MoD-flipper.webp" alt="MoD Flipper" />
        </section>
      </div>
    </section>
    ...
    <section class="competition-rules">
      ...
      <section class="competition-rules-content">
        ...
        <section class="competition-rules-content-left">
          <div>
            <h3>Trade to increase your rank
            </h3>
            <p>Eligible pairs: DAR/BNB, CAKE/BNB, and CAKE/BUSD. Please note that the volume from limit orders will not be indexed.
            </p>
          </div>
          <div>
            <h3>Play as a team
            </h3>
            <p>The higher your team’s rank, the better your prizes!
            </p>
          </div>
          <div>
            <h3>Everyone’s a winner!
            </h3>
            <p>Sign up for battle and you’re guaranteed a prize!
            </p>
          </div>
        </section>
          ...
          <div>
            <details>
              <summary>
                ...
                <div>
                  <p>Only trades on DAR/BNB, CAKE/BNB, and CAKE/BUSD pairs will be included in volume calculations. Please note that the volume from limit orders will not be included.
                  </p>
                </div>
            </details>
            <details>
              ...
              <div>
                <p>- Team ranks are calculated by the total combined volume of the top 500 members of each respective team.
                </p>
                <p>- The final winning team will be the team with the highest total volume score at the end of the competition period.
                </p>
              </div>
            ...
            <details>
              ...
              <div>
                <p>- Prizes to be distributed in CAKE and DAR in a distribution of 1:5 and shared by all members of each respective tier.
                </p>
                <p>- The price of token prizes ($CAKE and $DAR) in USD will be determined as per their BUSD pair price during the tally period.
                </p>
                <p>- Every participant will win at least one prize at the end of the competition.
                </p>
              </div>
            </details>
            <details>
              ...
              <div>
                <p>- In the event of a disagreement concerning the final winning team or rank, PancakeSwap will have the final say.
                </p>
                <p>- PancakeSwap can and will disqualify any team or specific members that are proven to have taken malicious action or attempt to “cheat” in any way.
                </p>
              </div>
            </details>
            <details>
              ...
              <div>
                <p>Sorry, no. You need to register during the registration period, before the start of the event.
                </p>
              </div>
            </details>
            <details>
              ...
              <div>
                <p>At the top of the page, the text in the button “I Want to Battle” will change to “Registered”.
                </p>
              </div>
            </details>
            <details>
              ...
              <div>
                <p>Check Your Score section on the event page. You’ll need to connect your wallet, of course.
                </p>
              </div>
            </details>
            <details>
              ...
              <div>
                <p>After the battle ends, visit the event page and click the “Claim Prizes” button in the top section or in “Your Score” section. Once you claim your prizes successfully, the button text will change to “Prizes Claimed”.
                </p>
              </div>
            </details>
          </div>
    ...
    <section class="competition-finished">
      ...
      <div class="competition-finished-container">
        ...
        <div>
          ...
          <div>
            <img src="./assets/competition/MoD-storm-bunny.webp" alt="Storm bunny"/>
            <h2>Finished!</h2>
            <img />
          </div>
