...
export const TopNavbar = () => {
  ...
  return (
    <nav className={isLight ? "header__navbar flex-row" : "header__navbar flex-row header-dark-DM"} >
      <div className="header__navbar__left flex-row">
        ...
        <ul className={isLight ? "header__navbar__left-links flex-row" : "header__navbar__left-links flex-row header-hover-DM"}>
          <li className="header__navbar__left-links--menu">
            <Link to="/">Trade</Link>
            <ul className={isLight ? "header__navbar__left-links--submenu" : "header__navbar__left-links--submenu header-submenu-DM header-hover-DM"}>
              <li>
          ...
          <li className="header__navbar__left-links--menu">
            ...
            <ul className={isLight ? "header__navbar__left-links--submenu" : "header__navbar__left-links--submenu header-submenu-DM header-hover-DM"}>
              ...
              <li>
                <Link to="/leaderboard" className={isLight ? "leaderboard" : "header-border-DM"}>
                  Leaderboard
                </Link>
              </li>
              <li className="flex-row">
      ...
      <div className="header__navbar__right flex-row">
        ...
        <div className="header__navbar__right-chain">
          <button className={isLight ? "flex-row" : "flex-row header-link-bnb-DM"}>
            ...
            <a>BNB Smart Chain</a>
            <img
              src={require(isLight ? "./assets/header/Down-Arrow.svg" : "./assets/header/Down-Arrow-DM.svg").default}
              alt=""
              className="arrow"
            />
          </button>
          <ul className={isLight ? "header__navbar__right-chain--submenu" : "header__navbar__right-chain--submenu header-submenu-DM header-hover-DM"}>
            <li className={isLight ? "" : "header-border-DM"}>
              <a>Select a Network</a>
            </li>
            <li className="flex-row">
              <a href="">
                <img src={bnbCoinIcon} alt="" />
              </a>
              <a href="">BNB Smart Chain</a>
            </li>
            <li className="flex-row">
              <a href="">
                <img src={ethCoinIcon} alt="" />
              </a>
              <a href="" className={isLight ? "" : "header-text-DM"}>Ethereum</a>
            </li>
          </ul>
        </div>
        <div className="header__navbar__right-connect flex-row">
          <button className={isLight ? "" : "header-btn-DM"}>Connect Wallet</button>
        </div>
      </div>
    </nav>
  );
