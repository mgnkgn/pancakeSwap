                                                ...
                                                <div>
                                                   {/*  <input
                                                    ...
                                                    function Convert () {
                                                        ...
                                                        const [currencyList3, setCurrencyList3] = useState([]);
                                                        const [currencyList4, setCurrencyList4] = useState([]);
                                                        const [currencyList5, setCurrencyList5] = useState([]);
                                                        const [currencyList6, setCurrencyList6] = useState([]);
                                                        const [currencyList7, setCurrencyList7] = useState([]);
                                                        const [currencyList8, setCurrencyList8] = useState([]);
                                                        const [currencyList9, setCurrencyList9] = useState([]);
                                                        const [currencyList10, setCurrencyList10] = useState([]);


                                                        const [currencyList11, setCurrencyList11] = useState([]);
                                                        const [currencyList12, setCurrencyList12] = useState([]);
                                                    }
                                                </div>
                                                <div></div>
                                            </label>
